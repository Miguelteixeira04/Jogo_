...
def abrir_janela_nomes_1v1():
    ...
    while digitando:
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_RETURN:
                    if jogador_atual == 1:
                        ...
                        nome_jogador1, nome_jogador2, primeiro_nome, segundo_nome = sortear(nome_jogador1, nome_jogador2)
                        digitando = False
                    ...
                    if jogador_atual == 1 and len(nome_jogador1) < 14:  # Limita a 16 caracteres
                        nome_jogador1 += event.unicode
                    elif jogador_atual == 2 and len(nome_jogador2) < 14:  # Limita a 16 caracteres
        ...
        janela.blit(menu_nomes_redim, (0, 0))
        janela.blit(botao_voltar_redim, (1200, 5))
        ...
        pygame.draw.rect(janela, CINZA, posicao_texto_jogador1)
        pygame.draw.rect(janela, CINZA, posicao_texto_jogador2)

        janela.blit(texto_jogador1, posicao_texto_jogador1)
        janela.blit(texto_jogador2, posicao_texto_jogador2)
...
def sortear(nome_jogador1, nome_jogador2):
    primeiro = rd.randint(1, 2)

    if primeiro == 1:
        primeiro_nome = nome_jogador1
        segundo_nome = nome_jogador2
    else:
        primeiro_nome = nome_jogador2
        segundo_nome = nome_jogador1
...
def abrir_tabuleiro_1v1(nome_jogador1, nome_jogador2, primeiro_nome, segundo_nome):
    janela = pygame.display.set_mode((screen_width, screen_height))
    ...
    while digitando:
        ...
        janela.blit(menu_tabuleiro_redim, (0, 0))
        janela.blit(botao_passarvez_redim, (855, 480))
        janela.blit(sair_redim, (1052, 625))

        # Exibindo os nomes dos jogadores
        fonte = pygame.font.Font(None, 46)
        label_nome1 = fonte.render(nome_jogador1, True, BRANCO)
        label_nome2 = fonte.render(nome_jogador2, True, BRANCO)

        if nome_jogador1 == primeiro_nome:
            posicao_label_nome1 = label_nome1.get_rect(midtop=(screen_width // 2, 200))
            posicao_label_nome2 = label_nome2.get_rect(midtop=(screen_width // 2, 300))
        else:
            posicao_label_nome1 = label_nome1.get_rect(midtop=(screen_width // 2, 300))
            posicao_label_nome2 = label_nome2.get_rect(midtop=(screen_width // 2, 200))

        janela.blit(label_nome1, posicao_label_nome1)
        janela.blit(label_nome2, posicao_label_nome2)
